...
# --- 5. NaN Detection ---
#   model output: shape=torch.Size([4, 10]), dtype=torch.float32, device=cpu, min=-0.3881, max=0.2530, mean=-0.0158, has_nan=False
#   Normal loss: 2.3111
#   NaN detected: False
#   Simulated NaN loss: nan
#   NaN loss detected at step 99
#   NaN detected: True
# ｜
# ｜
# ｜
# ｜
# 有nan
# model output: shape=torch.Size([4, 10]), dtype=torch.float32, device=cpu, min=nan, max=nan, mean=nan, has_nan=True
#   Normal loss: nan
#   NaN loss detected at step 0
#     NaN gradient in 0.weight
#     NaN gradient in 0.bias
#     NaN gradient in 2.weight
#     NaN gradient in 2.bias
#   NaN detected: True
#   Simulated NaN loss: nan
#   NaN loss detected at step 99
#     NaN gradient in 0.weight
...
#   NaN detected: True
    ...
    # 前向传播计算模型输出
    output = model(x)
    debug_print("model output", output)
